...
\name{\centerline{ALEXANDER ST LAURENT}\\\centerline{stlaurent.alexander@gmail.com}\\\centerline{(774) 289-6383}\\\\\centerline{awstlaurent.com}\\\\}
...
\sbreak
{\bf Tantasqua Regional High School} $\cdot$ Fiskdale, MA $\cdot$ June 2011\\%\>GPA: 4.86/5.00, Rank 3\textsuperscript{rd}/291\\
\end{tabbing}
\sectionVspace %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EMPLOYMENT \& EXPERIENCE}
 ...
 {\bf Teaching Assistant} $\cdot$ Brown Computer Science $\cdot$ Providence, RI\\
	...
	% \>$\bullet$  Ensured assignments and TA solutions were well-written and accurate.\\
\sbreak
